   ...
   client.on("message", message => {
    if (message.content === "-help--1") {
     const embed = new Discord.RichEmbed() 
         ...
         .setColor("#00FF00")
         .setDescription(`**  السيرفر الرسمي للبوت :  :dove:  https://discord.gg/zf4zQq :scroll: **`)
...
**============ **
  ** Gmove @user |  لسحب الشخص الى روومك** :confused: 

  ** Gbc | رسالة جماعية الى كل اعضاء السيرفر** :mega:

  ** Grole @user <rank> | لأعطاء رتبة لعضو معين**:large_orange_diamond: 

  ** Groleremove @user <rank> | لازالة الرتبة من شخص معين** :orange_book: 

  ** Grole all <rank> | لأعطاء رتبة للجميع**:shield: 

  ** Grole humans <rank> | لأعطاء رتبة للاشخاص فقط **:man: , :woman: 

  **Grole bots <rank> | لأعطاء رتبة لجميع البوتات**:robot: 

  ** Gschannel | اضهار الشات المخفية**:blush: 

  ** Ghchannel | اخفاء الشات**:arrow_heading_down: 

  ** Gclr <numbr> | مسح الشات بعدد**:information_source: 

  ** Gclear | مسح الشات ** :recycle: 

  ** G-mute @user <reason> | اعطاء العضو ميوت لازم رتبة <Muted>**:mute:

  ** Gunmute @user | لفك الميوت عن الشخص ** :loud_sound:

  ** Gkick @user <reason> | طرد الشخص من السيرفر**  :outbox_tray:

  ** Gban @user <reason> | حضر الشخص من السيرفر** :no_entry:

  ** Gmutechannel | تقفيل الشات**:no_entry:

  ** Gunmutechannel | فتح الشات**:on:   

  ** Gdc | مسح كل الرومات**

  ** Gdr | <مسح كل الرانكات <لازم تكون رانك البوت فوق كل الرانكات**

  ** Gct <name> | انشاء شات**:rolling_eyes:

  ** Gcv <name> | انشاء رووم فويس**:crown:
